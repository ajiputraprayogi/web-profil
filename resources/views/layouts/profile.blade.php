            ...
            <div class="profile-head">
                <div class="row vh-100">
                    <div class="col-xl-6 text-center mx-auto align-self-center ">
                         <div class="imgcover mb-4">
                             <img src="{{asset('profile-website/assets/images/ajiputraprayogi_square.jpeg')}}" class="rounded-pill bg-white p-2 shadow" alt="">
                         </div>
                         <b class="fs-6">Halo Perkenalkan saya, Aji Putra Prayogi</b>
                         <h1 class="fw-bold mb-4 fs-1">Mid-dle Programmer</h1>
                         {{-- <h1 class="fw-bold mb-4 fs-1">Full Stack Developer</h1> --}}
                         <p>Saya adalah seorang manusia biasa bukan superman, pencapaian terbesar dalam hidup saya adalah bisa bangun, makan, dan tidur.</p>
                         <ul>
                             <li></li>
                         </ul>
             ...
             <div id="about" class="about px-4 bg-white py-5">
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-5">
                         <img src="{{asset('profile-website/assets/images/ajiputraprayogi_profile.jpeg')}}" alt="">
                     </div>
                 </div>
             </div>
                 ...
                 <div class="row mt-5">
                     <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-2">
                             <img src="{{asset('profile-website/assets/images/blog/1.jpg')}}" alt="">
                             <h5 class="mt-3 fs-6 fw-bold">Creative Page Design</h5>
                        </div>
                     </div>
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-2">
                             <img src="{{asset('profile-website/assets/images/blog/2.jpg')}}" alt="">
                             <h5 class="mt-3 fs-6 fw-bold">Creative Page Design</h5>
                        </div>
                     </div>
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-2">
                             <img src="{{asset('profile-website/assets/images/blog/3.jpg')}}" alt="">
                             <h5 class="mt-3 fs-6 fw-bold">Creative Page Design</h5>
                        </div>
                     </div>
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-2">
                             <img src="{{asset('profile-website/assets/images/blog/4.jpg')}}" alt="">
                             <h5 class="mt-3 fs-6 fw-bold">Creative Page Design</h5>
                        </div>
                     </div>
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-2">
                             <img src="{{asset('profile-website/assets/images/blog/5.jpg')}}" alt="">
                             <h5 class="mt-3 fs-6 fw-bold">Creative Page Design</h5>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-2">
                             <img src="{{asset('profile-website/assets/images/blog/6.jpg')}}" alt="">
                             <h5 class="mt-3 fs-6 fw-bold">Creative Page Design</h5>
                        </div>
                     </div>
                 </div>
                 ...
                 <div class="row mt-5">
                     <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-3">
                             <div class="prf row mb-3">
                                 <div class="col-md-3">
                                     <img class="rounded-pill" src="{{asset('profile-website/assets/images/testimonial/member-01.jpg')}}" alt="">
                                 </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-3">
                             <div class="prf row mb-3">
                                 <div class="col-md-3">
                                     <img class="rounded-pill" src="{{asset('profile-website/assets/images/testimonial/member-03.jpg')}}" alt="">
                                 </div>
                                 <div class="col-md-9 align-self-center">
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                        <div class="serv-cove shadow-md rounded bg-white p-3">
                             <div class="prf row mb-3">
                                 <div class="col-md-3">
                                     <img class="rounded-pill" src="{{asset('profile-website/assets/images/testimonial/member-02.jpg')}}" alt="">
                                 </div>
                                 <div class="col-md-9 align-self-center">
